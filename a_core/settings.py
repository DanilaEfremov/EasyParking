...
DEBUG = bool(os.getenv("DEBUG", "False") == "True" and BUILD == "dev")

if DEBUG:
    logger = structlog.get_logger(__name__)
    logger.info("Django settings loading...")
    logger.info(f"Django mode is {BUILD}, DEBUG is {DEBUG}")  # noqa: G004
...
if DEBUG:
    ...
    import mimetypes
    mimetypes.add_type("application/javascript", ".js", True)  # noqa: FBT003

    # Только это заставило работать Django Debug Toolbar за Nginx
    DEBUG_TOOLBAR_CONFIG = {
        "INTERCEPT_REDIRECTS": False,
        "SHOW_TOOLBAR_CALLBACK": lambda request: True,  # noqa: ARG005
    }
...
# https://docs.djangoproject.com/en/5.2/topics/db/fixtures/
FIXTURE_DIRS = [
